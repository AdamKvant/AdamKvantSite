...
<div class="headerOverall rounded-b-lg justify-between items-center flex relative">
    ...
    <!-- Dropdown Menu -->
    <div class={`absolute top-12 right-0 bg-[#B8001F] md:w-5/12 xl:w-7/12 shadow-md rounded-b-lg flex flex-col items-start gap-4 p-5 md:hidden transition-all duration-500 
        ...
        <a on:click={toggleMenu} class="hoverHeaderHam w-full text-right border border-b-4 border-x-0 border-t-0 pb-1.5" href="/blog">Blog</a>
    </div>
</div>
